...
Para que una tercera persona pudiese interceptar la comunicación tendría que calcular \(K_{ij}\) a partir de \(Y_i\) e \(Y_j\), para lo que tendría que calcular, por ejemplo, \[K_{ij} = Y_i^{(log_{\alpha} Y_j)} \mod q,\] problema que, como ya hemos comentado antes, tiene una complejidad considerable.
