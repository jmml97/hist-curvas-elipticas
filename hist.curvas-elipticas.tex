...
% Dadas dos curvas elípticas, \(E_1\) y \(E_2\), podemos definir una función \(\phi\), que llamamos \textit{isogenia}, asignando cada punto de \(E_1\) en uno de \(E_2\).
% Aplicando de forma sucesiva dicha isogenia llegaremos a una curva \(E_p\).
% La tarea de un atacante sería reconstruir el camino que se ha tomado desde la curva inicial hasta la final.
